 ...
 * 作者:wangtao
 */
public class PaidsFragment extends BaseUserFragment<IndentPresenter> implements IndentView{
    ...
    protected int protetedId() {
        return R.layout.indent_fragment_but_paids;
    }
    ...
    protected void initView(View view) {
        ...
        recyclerView = view.findViewById(R.id.activity_indent_paid_recycle);
        sumpriceText = view.findViewById(R.id.activity_indent_paid_commodity_car_btn);
        infpText = view.findViewById(R.id.activity_indent_paid_userInfo);
        siteText = view.findViewById(R.id.activity_indent_paid_site);
        imageView = view.findViewById(R.id.activity_indent_paid_right_image);
    }
    ...
    public static Fragment create(String title) {
        ...
        Fragment fragment=new PaidsFragment();
